...
<template>
  <div class="result-whole-style">
    <div class="grid-container-main">
      <div class="grid-item-main right-grey-border" style="padding-left: 25px;">
      ...
      <div class="grid-item-main grid-col-2 right-grey-border left-grey-border" style="padding-left:45px;padding-right:15px">
      ...
      <div class="grid-item-main right-grey-border left-grey-border" style="padding-left:45px;padding-right:15px">
        <div class="grid-container-child grid-col-1">
      ...
      <div class="grid-item-main left-grey-border" style="padding-left:45px;padding-right:15px">
        <div class="grid-container-child grid-col-1">
