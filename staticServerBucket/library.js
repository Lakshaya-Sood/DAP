...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/tourManger/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
function () {
  ...
  _createClass(Tour, [{
    ...
    value: function start() {
      ...
      script("".concat(window.appConfig.rootFolderLink, "tour.").concat(this.stepDefURI, ".js")).then(function () {
        console.log("step defination for tour: ".concat(_this.name, " is successfully fecthed. Filename: tour.").concat(_this.stepDefURI, ".js"));
        _this.stepData = window[_this.stepDefURI];
        hopscotch__WEBPACK_IMPORTED_MODULE_0___default.a.startTour(_this.stepData);
      }).catch(function (err) {
...
/* harmony import */ var _Tour__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Tour */ "./src/tourManger/Tour.js");
...
function () {
  ...
  _createClass(TourManager, [{
    key: "setTours",
    value: function setTours(tourObjList) {
    ...
    value: function renderTours(tours, connectManager) {
      ...
      tours.forEach(function (tour, index) {
        ...
        listHtml += "\n                <tr>\n                    <td id=\"".concat(tour.tour_id, "\" style=\"padding: 15px;cursor:pointer;\">").concat(index + 1, ". ").concat(tour.tour_name, "</td>\n                </tr>\n            ");
      });
...
/* harmony import */ var _TourManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TourManager */ "./src/tourManger/TourManager.js");


var managerobj = new _TourManager__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').append("<button id='tourBttn'>Quick Tour</button>");
